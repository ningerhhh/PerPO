...
from .base_perpo_trainer_next import BasePerPOTrainer
...
class LlavaPerPOTrainer(BasePerPOTrainer):
    ...
    def concatenated_forward(
        ...
        (
            ...
            labels=batch_labels,
            images= images * best_of_n,
            modalities = modalities * best_of_n,
            image_sizes = image_sizes * best_of_n,
        )
    ...
    def compute_loss(
        ...
        model: Union[LlavaLlamaForCausalLM, nn.Module],

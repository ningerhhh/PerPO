...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        # ### 后加的!!!!
        # if "unpad" in config.mm_patch_merge_type:
        ...
        #     print("44444", self.image_newline)
    ...
    # def get_image_newline(self):
    #     print("self.image_newline", self.image_newline)
    #     return self.image_newline
    ...
    def forward(
        ...
        # print("8888888888888888888", self.model.image_newline)
        # print(abc)
